  ...
  const services = [
    {
      ...
      description: 'Создание современных программных решений, веб-приложений и корпоративных систем для автоматизации бизнес-процессов',
      color: 'bg-blue-50 text-blue-600'
    },
    {
      icon: 'Package',
      title: 'Разработка и производство товаров',
      description: 'Инновационные продукты высокого качества — от концепции до серийного производства',
      color: 'bg-slate-50 text-slate-600'
    },
    {
      icon: 'TreePine',
      title: 'Рекреационная деятельность',
      description: 'Организация корпоративного отдыха, тимбилдинг мероприятий и развлекательных программ',
      color: 'bg-green-50 text-green-600'
    },
    {
      icon: 'Fuel',
      title: 'Торговля ГСМ',
      description: 'Оптово-розничная торговля горюче-смазочными материалами премиум класса с доставкой',
      ...
      <section id="services" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">Комплексные решения для развития вашего бизнеса в четырех ключевых областях</p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                ООО "Кайлаб" — многопрофильная компания, специализирующаяся на разработке 
                программного обеспечения, производстве товаров, организации рекреационной 
                деятельности и торговле ГСМ. Мы предоставляем комплексные решения для бизнеса.
              </p>
